...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        case 0:
            question.innerHTML = "Are you ready to start your jungle adventure?";
            break;
        case 1:
            question.innerHTML = "Enter the jungle, or stay at camp?";
            break;
        case 2:
            question.innerHTML = "Cross the bridge, or follow the river?";
            break;
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        case 0:
            ...
            break;
        case 1:
            if (answers[1] === "ENTER THE JUNGLE") {
                story.innerHTML = document.getElementById("answer11").innerHTML;
                askQuestion(2);
            } else if (answers[1] === "STAY AT CAMP") {
            ...
            break;
        case 2:
            if (answers[2] === "CROSS THE BRIDGE") {
                story.innerHTML = document.getElementById("answer21").innerHTML;
                theEnd();
            } else if (answers[2] === "FOLLOW THE RIVER") {
